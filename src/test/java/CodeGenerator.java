...
public class CodeGenerator {
    //JDBC配置，请修改为你项目的实际配置
    private static final String JDBC_URL = "jdbc:mysql://localhost:3306/wx-admin";
    private static final String JDBC_USERNAME = "root";
    private static final String JDBC_PASSWORD = "Tcpjw@123";
    ...
    public static void main(String[] args) {
        genCodeByCustomModelName("user_activity_code","UserActivityCode");
